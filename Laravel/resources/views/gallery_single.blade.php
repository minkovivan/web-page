            ...
            <div class="container">
                <div class="header_inner">
                    <div class="header_contacts">
                        ...
                        <div class="flagmedia">
                        <img src="{{asset("images/flagmedia.png")}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="gallery_intro_photos">
                    <div class="about_gallery_photos">
                        <div class="gallery{{$id}}">
                            <img src="{{asset("images/gallery$id.png")}}" width="100%" alt="">
                        </div>
                        <div class="gallerymedia{{$id}}">
                            <img src="{{asset("images/gallerymedia$id.png")}}" alt="">
                        </div>
                        <h2 class="photos_description">{{$text}}</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="gallery_intro">
            <div class="container">
                ...
                <gallery_intro_button1_1 class="gallery_intro_button1_1">
                    <a class="gal_in_button1_1" href="{{route("order")}}">Зв'язатись з нами</a>
                </gallery_intro_button1_1>
                <gallery_intro_button1 class="gallery_intro_button1">
                    <a class="gal_in_button1" href="{{route("order")}}">Зв'язатись з нами</a>
                ...
                <gallery_intro_button2 class="gallery_intro_button2">
                    <a class="gal_in_button2" href="{{route("order")}}">+38 099 976 1234</a>
