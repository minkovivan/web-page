            ...
            <div class="container">
                <div class="header_inner">
                    <div class="header_contacts">
                        ...
                        <a class="nav_link" href="{{route('order')}}">Замовлення</a>
                        <a class="nav_link" href="{{route('gallery')}}">Галерея</a>
                        </nav>
                        <div class="flag">
        ...
        <div class="gallery_intro">
            <div class="container">
                <div class="gallery_intro_photos">
                    <a class="about_gallery_photos" href="{{route("gallery")."/1"}}">
                        <div class="gallery1">
                    ...
                    <a class="about_gallery_photos" href="{{route("gallery")."/2"}}">
                        <div class="gallery2">
                    ...
                    <a class="about_gallery_photos" href="{{route("gallery")."/3"}}">
                        <div class="gallery3">
                    ...
                    <a class="about_gallery_photos" href="{{route("gallery")."/4"}}">
                        <div class="gallery4">
                    ...
                    <a class="about_gallery_photos" href="{{route("gallery")."/5"}}">
                        <div class="gallery5">
                    ...
                    <a class="about_gallery_photos" href="{{route("gallery")."/6"}}">
                        <div class="gallery6">
                    ...
                    <a class="about_gallery_photos" href="{{route("gallery")."/7"}}">
                        <div class="gallery7">
                    ...
                    <a class="about_gallery_photos" href="{{route("gallery")."/8"}}">
                        <div class="gallery8">
