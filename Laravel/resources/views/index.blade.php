            ...
            <div class="container">
                ...
                <div class="intro_inner">
                    ...
                    <intro_button class="intro_button">
                        <a class="in_button" href="{{route('order')}}">Зв'язатись з нами</a>
                    </intro_button>
                    </div>
                    <intro_button1 class="intro_button1">
                        <a class="in_button1" href="{{route('order')}}">Зв'язатись з нами</a>
                    </intro_button1>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="third_intro_photos">
                    <div class="about_photos">
                        <a class="photo_link" href="{{route('gallery')}}">
                        <div class="photo1">
                ...
                <div class="about_footer">
                    ...
                    <div class="footer_text">
                        ...
                        <nav_foot class="nav_foot">
                            <a class="foot_link" href="{{route("order")}}">WhatsApp<br></a>
                            <a class="foot_link" href="{{route("order")}}">Instagram<br></a>
                            <a class="foot_link" href="{{route("order")}}">Facebook<br></a>
                            <a class="foot_link" href="{{route("order")}}">+38 099 976 1234</a>
                            </nav_foot>
                    </div>
                </div>
