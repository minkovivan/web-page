            ...
            <div class="container">
                ...
                <div class="intro_inner">
                    ...
                    <intro_button class="intro_button">
                        <a class="in_button" href="<?php echo e(route('order')); ?>">Зв'язатись з нами</a>
                    </intro_button>
                    </div>
                    <intro_button1 class="intro_button1">
                        <a class="in_button1" href="<?php echo e(route('order')); ?>">Зв'язатись з нами</a>
                    </intro_button1>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="third_intro_photos">
                    <div class="about_photos">
                        <a class="photo_link" href="<?php echo e(route('gallery')); ?>">
                        <div class="photo1">
                ...
                <div class="about_footer">
                    ...
                    <div class="footer_text">
                        ...
                        <nav_foot class="nav_foot">
                            <a class="foot_link" href="<?php echo e(route("order")); ?>">WhatsApp<br></a>
                            <a class="foot_link" href="<?php echo e(route("order")); ?>">Instagram<br></a>
                            <a class="foot_link" href="<?php echo e(route("order")); ?>">Facebook<br></a>
                            <a class="foot_link" href="<?php echo e(route("order")); ?>">+38 099 976 1234</a>
                            </nav_foot>
                    </div>
                </div>
...
<?php /**PATH E:\WORK\PHPProjects\Apollo\resources\views/index.blade.php ENDPATH**/ ?>